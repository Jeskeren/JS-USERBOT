...
async def _(event):
    ...
    if input_str == "owner":
        ...
        animation_chars = [
            "**OWNER JESS-USERBOT ADALAH MANUSIA TERGANTENG DI HATI PEMAKAI NYA, KENALAN DULU SAMA OWNER NYA YUK**"
            "** JESS NAMANYA,ORANG NYA BAIK**"
            "**TINGGAL NYA DI KALSEL, BTW ORANG KALIMANTAN GANTENG GANTENG DAN THEBEST POKOK NYA AWWHHHH**"
